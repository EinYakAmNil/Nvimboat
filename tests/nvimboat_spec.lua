...
describe("nvimboat", function()
	...
	it("can toggle articles of a feed", function()
		...
		-- dump_buffer()
		-- print()
		vim.cmd.Nvimboat("toggle-read", "https://lukesmith.xyz/updates/lindypress-bug-fix/", "https://lukesmith.xyz/articles/blockchain-blasphemy/")
		-- dump_buffer()
	end)
	...
	-- 	eq("MainMenu", nvimboat.page.page_type)
	-- end)
	-- it("calls the new command handler", function ()
	-- 	vim.cmd.NvimboatTest("hello", "world")
	-- end)
end)
