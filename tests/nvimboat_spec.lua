...
describe("nvimboat", function()
	...
	it("can select a tag", function()
		...
		vim.cmd.Nvimboat("select", "https://www.youtube.com/feeds/videos.xml?channel_id=UCBzYAtjNpudOSCP5_8W1iAw")
		eq("Feed", nvimboat.page.page_type)
		-- dump_buffer()
	end)
	it("can show the next article", function()
		...
		-- dump_buffer()
		vim.cmd.Nvimboat("back")
		vim.cmd.Nvimboat("select", "https://lukesmith.xyz/articles/why-do-i-so-rarely-talk-about-politics-on-my-channel/")
		-- dump_buffer()
		vim.cmd.Nvimboat("next-article")
		-- dump_buffer()
		vim.cmd.Nvimboat("next-article")
